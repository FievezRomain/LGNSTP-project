                  ...
                  <form class="col s12" action="" method="POST">
                    <div class="row">
                      ...
                      <div class="col s4 right">
                        <div class="card">
                          <div class="card-image">
                              <a href="https://www.airfrance.fr/"><img src="../vue/ressources/airfrance.png"></a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row center">
                      <div class="col s12">
                        <a href="../vue/ressources/CVROMAIN.pdf" download="CV.pdf"><i class="material-icons medium">file_download</i></a>
                        <p><b>CV.pdf</b></p>
                      </div>
                    </div>
                  </form>

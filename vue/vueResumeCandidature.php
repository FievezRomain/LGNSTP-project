              ...
              <div class="card-panel">
                ...
                <div class="row">
                  <form class="col s12" action="" method="post">
                    ...
                    <div class="row">
                      <div class="input-field col s12">
                        <p><?php echo $lettreM?></p>
                        <label for="lettreMotivation" class="active">Lettre de motivation</label>
                      </div>
                      <div class="row">
                        <div class="input-field col s12">
                          <button class="btn waves-effect waves-light right" type="submit" name="sauvegarder">Sauvegarder
                            <i class="mdi-content-send right"></i>
                          </button>
                          <button class="btn waves-effect waves-light left" type="submit" name="retour">Retour
